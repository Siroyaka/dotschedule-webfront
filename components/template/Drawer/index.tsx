...
const Drawer: React.FC<Props> = (props) => {
  ...
  return(
    <React.Fragment>
      ...
      <aside className={clsx(className, 'bg-white transform duration-300 ease-in-out h-full fixed z-40 top-0 left-0 transition-all flex flex-col w-64 border-r border-gray-200 px-2', `${open ? 'translate-x-0' : '-translate-x-full'}`)}>
        <div id='drawerHeader' className='h-12 bg-white border-b w-full flex flex-row justify-start py-1'>
